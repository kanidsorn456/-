...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">แก้ไขข้อมูลผลงานพระสงฆ์</h1>
            <div class="mt-4">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="row mt-4">
                            ...
                            <!-- แถวที่ 2 -->
                            <div class="col-md-4 mt-3">
                                <label for="c_idcard" class="form-label">เลขประจำตัว</label>
                            ...
                            <div class="col-md-4 mt-3">
                                <label for="c_mobile" class="form-label">รหัสภาพ</label>
                                <input type="text" id="c_mobile" name="c_mobile" class="form-control" value="<?php echo $objResult['c_mobile']; ?>">
                            </div>
                            <!-- แถวที่ 3 -->
                            <div class="col-md-12 mt-3">
                                <label for="c_detail" class="form-label">รายละเอียดผลงาน</label>
