...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">รายการข้อมูลผลงานพระสงฆ์</h1>
            <!-- ปุ่มเพิ่มข้อมูล -->
            <div class="mt-4">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><div class="col-md-12 mt-3">
                                ...
                                <?php } ?>
                                <td>
                                <a href="update.php?c_id=<?php echo $objResult['c_id']; ?>" class="btn btn-warning btn-sm">อัพเดท</a>
                                <a href="action_delete.php?c_id=<?php echo $objResult['c_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยัน');">ลบข้อมูล</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
