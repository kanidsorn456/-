...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">เพิ่มข้อมูลพระสงฆ์</h1>
            <div class="mt-4">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="row mt-4">
                            ...
                            <!-- แถวที่ 2 -->
                            <div class="col-md-4 mt-3">
                                <label for="c_idcard" class="form-label">เลขประจำตัว <span class="text-danger">*</span></label>
                                <input type="text" id="c_idcard" name="c_idcard" class="form-control" minlength="1" maxlength="13" required>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="c_birthdate" class="form-label">วัน/เดือน/ปี <span class="text-danger">*</span></label>
                                <input type="date" id="c_birthdate" name="c_birthdate" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="c_mobile" class="form-label">รหัสภาพ<span class="text-danger">*</span></label>
                                <input type="text" id="c_mobile" name="c_mobile" class="form-control" required>
                            </div>
                            <!-- แถวที่ 3 -->
                            <div class="col-md-12 mt-3">
                                <label for="c_detail" class="form-label">รายละเอียดผลงาน <span class="text-danger">*</span></label>
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container">
            <span class="text-muted">&copy; วัดหัวเนิน 2024</span>
        </div>
    </footer>
